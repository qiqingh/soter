   ...
   case "$IPV6_WAN_PROTO" in
      normal)
         ...
         asyncid=`sysevent async guest_lan-status /etc/init.d/service_wan_ipv6/default_ipv6_link.sh`
         sysevent set ${SERVICE_NAME}_guest_lan-status_asyncid "$asyncid"
      ...
      bridge)
         ...
         sysevent set ${SERVICE_NAME}_lan-status_asyncid "$asyncid"
         asyncid=`sysevent async guest_lan-status /etc/init.d/service_wan_ipv6/bridge_link.sh`
         sysevent set ${SERVICE_NAME}_guest_lan-status_asyncid "$asyncid"
      ...
      6rd)
         ...
         sysevent set ${SERVICE_NAME}_lan-status_asyncid "$asyncid"
         asyncid=`sysevent async guest_lan-status /etc/init.d/service_wan_ipv6/6rd_link.sh`
         sysevent set ${SERVICE_NAME}_guest_lan-status_asyncid "$asyncid"
