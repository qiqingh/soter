		...
		if [ "0" = "$CONF_CHANNEL" ]; then
			...
			if [ "20" = "$BANDWIDTH" ]; then
				...
				if [ "wl0" = "$VIR_IFNAME" ]; then
					...
					if [ 36 = $ic -o 44 = $ic -o 52 = $ic -o 60 = $ic -o 149 = $ic -o 157 = $ic -o 100 = $ic -o 108 = $ic -o 116 = $ic -o 124 = $ic -o 132 = $ic ]; then
						SIDEBAND="l"
					elif [ 40 = $ic -o 48 = $ic -o 56 = $ic -o 64 = $ic -o 153 = $ic -o 161 = $ic -o 104 = $ic -o 112 = $ic -o 120 = $ic -o 128 = $ic -o 136 = $ic ]; then
						SIDEBAND="u"
					else
						SIDEBAND=""
					fi	    	
			...
			if [ "$CHANNEL_SIDEBAND" = "$CHANSPEC" ]; then
				...
				wl -i $ifs up
				if [ "a" = "`wl -i $ifs band`" ] && [ "`syscfg get wl1_chip`" = "11ac" ]; then
