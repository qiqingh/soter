   ...
   echo "dhcp-range=interface:$SYSCFG_guest_lan_ifname,set:$SYSCFG_guest_lan_ifname,$GUEST_DHCP_START_ADDR,$GUEST_DHCP_END_ADDR,$GUEST_LAN_NETMASK,$GUEST_DHCP_LEASE_TIME" >> $LOCAL_DHCP_CONF
