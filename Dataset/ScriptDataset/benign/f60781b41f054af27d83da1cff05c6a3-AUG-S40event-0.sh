...
event WAN-1.UP		insert "HW_ACCEL:service HW_ACCEL restart"
event WAN-1.DOWN	add "service HW_ACCEL stop"
event WAN-1.DOWN	insert "INFSVCS.WAN-1:service INFSVCS.WAN-1 stop"
...
event BRIDGE-3.UP	add "service INFSVCS.BRIDGE-3 restart"
event BRIDGE-3.DOWN	add "service INFSVCS.BRIDGE-3 stop"
event BRIDGE-4.UP	add "service INFSVCS.BRIDGE-4 restart"
event BRIDGE-4.DOWN	add "service INFSVCS.BRIDGE-4 stop"
...
event DOWNLINK-RESTART          add "/etc/events/DOWNLINK-RESTART.sh"
event MACSCAN          add "/etc/events/MACSCAN.sh"
event MACACL          add "phpsh /etc/events/MACACL.php"
event SEALPAC.LOAD
service LOGD start &
