	...
	SYSCFG_FAILED='false'
	FOO=`utctx_cmd get device::deviceType wl_wmm_support lan_ifname lan_wl_physical_ifnames wl0_ssid wl1_ssid wl0_state wl0_guest_vap guest_enabled guest_lan_ifname guest_wifi_phy_ifname guest_ssid_suffix guest_ssid guest_ssid_broadcast guest_lan_ipaddr guest_lan_netmask guest_vlan_id backhaul_ifname_list extender_radio_mode`
	eval $FOO
