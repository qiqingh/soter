...
xmldbc -P /etc/scripts/wps/wps.php -V PARAM1=save -V PARAM2=REPEATER -V BAND=24G -V SSID="$1" -V AUTHMODE=$2 -V ENCRTYPE=$3 -V KEYINDEX=$4 -V KEYSTR="$5" -V UUID=$6 -V EVENTTYPE=$7 > /var/run/wps_repeater_24G.sh
