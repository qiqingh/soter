...
xmldbc -P /etc/scripts/wps/wps.php -V PARAM1=save -V PARAM2=STA -V BAND=5G -V SSID="$1" -V AUTHMODE=$2 -V ENCRTYPE=$3 -V KEYINDEX=$4 -V KEYSTR="$5" -V UUID=$6 -V EVENTTYPE=$7 > /var/run/wps_sta_5G.sh
