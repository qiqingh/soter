   FOO=`utctx_cmd get lan_ifname dot_local_domain dot_local_hostname ula_enable lan_ula_prefix ui::remote_host cloud::host xmpp_host device::modelNumber private_domain`
   eval $FOO
